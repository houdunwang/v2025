    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'code' => \App\Services\CodeService::class,
            ...
            'dynamic' => \App\Services\DynamicService::class,
            ...
            'image' => \App\Services\ImageServer::class,
            'learn' => \App\Services\LearnService::class,
            'limiter' => \App\Services\LimiterService::class,
            ...
            'oss' => \App\Services\OssService::class,
            ...
            'sms' => \App\Services\SmsService::class,
            'translation.loader' => \Illuminate\Translation\FileLoader::class,
            'translator' => \Illuminate\Translation\Translator::class,
            'upload' => \App\Services\UploadServer::class,
    ...
    override(\config(), map([
            ...
            'common.app_logo' => 'string',
            'common.app_icp' => 'string',
            'common.copyright' => 'string',
            'common.wechat' => 'string',
            'common.email' => 'string',
            'common.site_close_message' => 'string',
            'common.site_open' => 'integer',
            ...
            'filesystems.disks.app.driver' => 'string',
            'filesystems.disks.app.root' => 'string',
            'filesystems.disks.app.serve' => 'boolean',
            'filesystems.disks.app.throw' => 'boolean',
            'filesystems.disks.app.report' => 'boolean',
            'filesystems.links./Users/hd/code/hdedu/laravel/public/storage' => 'string',
            ...
            'pay.alipay.default.app_id' => 'string',
            'pay.alipay.default.app_secret_cert' => 'string',
            'pay.alipay.default.app_public_cert_path' => 'string',
            'pay.alipay.default.alipay_public_cert_path' => 'string',
            'pay.alipay.default.alipay_root_cert_path' => 'string',
            'pay.alipay.default.return_url' => 'string',
            'pay.alipay.default.notify_url' => 'string',
            'pay.alipay.default.app_auth_token' => 'string',
            'pay.alipay.default.service_provider_id' => 'string',
            'pay.alipay.default.mode' => 'integer',
            'pay.wechat.default.mch_id' => 'string',
            'pay.wechat.default.mch_secret_key_v2' => 'string',
            'pay.wechat.default.mch_secret_key' => 'string',
            'pay.wechat.default.mch_secret_cert' => 'string',
            'pay.wechat.default.mch_public_cert_path' => 'string',
            'pay.wechat.default.notify_url' => 'string',
            'pay.wechat.default.mp_app_id' => 'string',
            'pay.wechat.default.mini_app_id' => 'string',
            'pay.wechat.default.app_id' => 'string',
            'pay.wechat.default.sub_mp_app_id' => 'string',
            'pay.wechat.default.sub_app_id' => 'string',
            'pay.wechat.default.sub_mini_app_id' => 'string',
            'pay.wechat.default.sub_mch_id' => 'string',
            'pay.wechat.default.wechat_public_cert_path.PUB_KEY_ID_0116994476832025032100388000002396' => 'string',
            'pay.wechat.default.mode' => 'integer',
            'pay.unipay.default.mch_id' => 'string',
            'pay.unipay.default.mch_secret_key' => 'string',
            'pay.unipay.default.mch_cert_path' => 'string',
            'pay.unipay.default.mch_cert_password' => 'string',
            'pay.unipay.default.unipay_public_cert_path' => 'string',
            'pay.unipay.default.return_url' => 'string',
            'pay.unipay.default.notify_url' => 'string',
            'pay.unipay.default.mode' => 'integer',
            'pay.douyin.default.mch_id' => 'string',
            'pay.douyin.default.mch_secret_token' => 'string',
            'pay.douyin.default.mch_secret_salt' => 'string',
            'pay.douyin.default.mini_app_id' => 'string',
            'pay.douyin.default.thirdparty_id' => 'string',
            'pay.douyin.default.notify_url' => 'string',
            'pay.jsb.default.svr_code' => 'string',
            'pay.jsb.default.partner_id' => 'string',
            'pay.jsb.default.public_key_code' => 'string',
            'pay.jsb.default.mch_secret_cert_path' => 'string',
            'pay.jsb.default.mch_public_cert_path' => 'string',
            'pay.jsb.default.jsb_public_cert_path' => 'string',
            'pay.jsb.default.notify_url' => 'string',
            'pay.jsb.default.mode' => 'integer',
            'pay.logger.enable' => 'boolean',
            'pay.logger.file' => 'string',
            'pay.logger.level' => 'string',
            'pay.logger.type' => 'string',
            'pay.logger.max_file' => 'integer',
            'pay.http.timeout' => 'double',
            'pay.http.connect_timeout' => 'double',
            ...
            'system.aliyun_accesskey_id' => 'string',
            'system.aliyun_accesskey_secret' => 'string',
            'system.aliyun_oss_endpoint' => 'string',
            'system.aliyun_video_oss_bucket' => 'string',
            'system.aliyun_video_cdn_domain' => 'string',
            'system.aliyun_video_cdn_auth_key' => 'string',
            'system.aliyun_image_oss_bucket' => 'string',
            'system.aliyun_image_cdn_domain' => 'string',
            'system.aliyun_sms_sign' => 'string',
            'system.aliyun_sms_template' => 'string',
            'system.test_phone' => 'string',
            'system.aliyun_email_account' => 'string',
            'system.aliyun_email_password' => 'string',
            'system.aliyun_email_host' => 'string',
            'system.aliyun_email_port' => 'string',
            'system.upload_driver_local' => 'string',
            'system.upload_image_size' => 'string',
            'system.upload_image_type' => 'string',
            'system.upload_image_max_width' => 'string',
            'system.upload_image_max_height' => 'string',
            'system.upload_video_size' => 'string',
            'system.upload_video_type' => 'string',
            'system.pay_alipay_app_id' => 'string',
            'system.pay_alipay_secret_cert' => 'string',
            'system.pay_alipay_open' => 'integer',
            'system.pay_wepay_mch_id' => 'string',
            'system.pay_wepay_secret_key' => 'string',
            'system.pay_wepay_app_id' => 'string',
            'system.pay_wepay_open' => 'integer',
            'system.wechat_official_appid' => 'string',
            'system.wechat_official_secret' => 'string',
            'system.wechat_official_token' => 'string',
...
'captcha.default.length','captcha.default.width','captcha.default.height','captcha.default.quality','captcha.default.math',
'captcha.default.expire','captcha.default.encrypt','captcha.math.length','captcha.math.width','captcha.math.height',
'captcha.math.quality','captcha.math.math','captcha.flat.length','captcha.flat.width','captcha.flat.height',
...
'captcha.inverse.sharpen','captcha.inverse.blur','captcha.inverse.invert','captcha.inverse.contrast','common.app_name',
'common.app_logo','common.app_icp','common.copyright','common.wechat','common.email',
'common.site_close_message','common.site_open','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.app.driver','filesystems.disks.app.root','filesystems.disks.app.serve',
'filesystems.disks.app.throw','filesystems.disks.app.report','filesystems.links./Users/hd/code/hdedu/laravel/public/storage','logging.default','logging.deprecations.channel',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','pay.alipay.default.app_id','pay.alipay.default.app_secret_cert',
'pay.alipay.default.app_public_cert_path','pay.alipay.default.alipay_public_cert_path','pay.alipay.default.alipay_root_cert_path','pay.alipay.default.return_url','pay.alipay.default.notify_url',
'pay.alipay.default.app_auth_token','pay.alipay.default.service_provider_id','pay.alipay.default.mode','pay.wechat.default.mch_id','pay.wechat.default.mch_secret_key_v2',
'pay.wechat.default.mch_secret_key','pay.wechat.default.mch_secret_cert','pay.wechat.default.mch_public_cert_path','pay.wechat.default.notify_url','pay.wechat.default.mp_app_id',
'pay.wechat.default.mini_app_id','pay.wechat.default.app_id','pay.wechat.default.sub_mp_app_id','pay.wechat.default.sub_app_id','pay.wechat.default.sub_mini_app_id',
'pay.wechat.default.sub_mch_id','pay.wechat.default.wechat_public_cert_path.PUB_KEY_ID_0116994476832025032100388000002396','pay.wechat.default.mode','pay.unipay.default.mch_id','pay.unipay.default.mch_secret_key',
'pay.unipay.default.mch_cert_path','pay.unipay.default.mch_cert_password','pay.unipay.default.unipay_public_cert_path','pay.unipay.default.return_url','pay.unipay.default.notify_url',
'pay.unipay.default.mode','pay.douyin.default.mch_id','pay.douyin.default.mch_secret_token','pay.douyin.default.mch_secret_salt','pay.douyin.default.mini_app_id',
'pay.douyin.default.thirdparty_id','pay.douyin.default.notify_url','pay.jsb.default.svr_code','pay.jsb.default.partner_id','pay.jsb.default.public_key_code',
'pay.jsb.default.mch_secret_cert_path','pay.jsb.default.mch_public_cert_path','pay.jsb.default.jsb_public_cert_path','pay.jsb.default.notify_url','pay.jsb.default.mode',
'pay.logger.enable','pay.logger.file','pay.logger.level','pay.logger.type','pay.logger.max_file',
'pay.http.timeout','pay.http.connect_timeout','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'system.aliyun_accesskey_id','system.aliyun_accesskey_secret','system.aliyun_oss_endpoint','system.aliyun_video_oss_bucket','system.aliyun_video_cdn_domain',
'system.aliyun_video_cdn_auth_key','system.aliyun_image_oss_bucket','system.aliyun_image_cdn_domain','system.aliyun_sms_sign','system.aliyun_sms_template',
'system.test_phone','system.aliyun_email_account','system.aliyun_email_password','system.aliyun_email_host','system.aliyun_email_port',
'system.upload_driver_local','system.upload_image_size','system.upload_image_type','system.upload_image_max_width','system.upload_image_max_height',
'system.upload_video_size','system.upload_video_type','system.pay_alipay_app_id','system.pay_alipay_secret_cert','system.pay_alipay_open',
'system.pay_wepay_mch_id','system.pay_wepay_secret_key','system.pay_wepay_app_id','system.pay_wepay_open','system.wechat_official_appid',
'system.wechat_official_secret','system.wechat_official_token','telescope.enabled','telescope.domain','telescope.path',
...
'sanctum.csrf-cookie','telescope','lesson.index',
'lesson.store','lesson.show','lesson.update','lesson.destroy',
'chapter.index','chapter.store','chapter.show','chapter.update','chapter.destroy','video.index','video.store','video.show',
'video.update','video.destroy',
'topic.index','topic.store','topic.show','topic.update','topic.destroy','comment.index','comment.store','comment.show','comment.update',
'comment.destroy','sign.index','sign.store','sign.show','sign.update',
'sign.destroy','dynamic.index','dynamic.store','dynamic.show',
'dynamic.update','dynamic.destroy','learn.index','learn.store','learn.show',
'learn.update','learn.destroy','notification.index','notification.store',
'notification.show','notification.update','notification.destroy',
'package.index','package.store','package.show','package.update','package.destroy',
'order.index','order.store','order.show','order.update','order.destroy',
'pay.alipay.sync','pay.alipay.async','storage.app',);
...
'validation.uuid','validation.custom.attribute-name.rule-name','en.0','zh_CN.0',);
...
'VITE_APP_NAME','AccessKey_ID','AccessKey_Secret','ALIYUN_SIGN','TEST_PHONE',
'pay_alipay_app_id','wepay_mch_id','wepay_app_id','wepay_PUB_KEY_ID',);
